...
This project is dual-licensed under AGPL-3.0 (open source) and a Commercial License. See the `LICENSE` file for details. Commercial support is available; please reach out via email.
...
> Replaces: AWS Lambda, CF Workers
